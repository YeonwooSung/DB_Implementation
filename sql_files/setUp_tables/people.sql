...
INSERT INTO customer SET person_ID = 1, email_address = 'bob_jnr@bobson.com';


INSERT INTO person SET ID = 2, forename = 'Bob', middle_initials = 'A B', surname = 'Bobson', date_of_birth = '1978-10-23';

INSERT INTO customer SET person_ID = 2, email_address = 'bob_snr@bobson.com';

INSERT INTO person SET ID = 3, forename = 'Stephen', surname = 'Fry', date_of_birth = '1957-08-24';

INSERT INTO contributor SET person_ID = 3, biography = 'An English comedian, actor, writer, presenter, and activist.';

INSERT INTO customer SET person_ID = 3, email_address = 'sfry@email.com';


INSERT INTO person SET ID = 4, forename = 'Hugh', surname = 'Laurie', date_of_birth = '1959-06-10';

INSERT INTO contributor SET person_ID = 4, biography = 'An English actor, musician, comedian, and writer.';

INSERT INTO customer SET person_ID = 4, email_address = 'hugh@laurie.com';


INSERT INTO person SET ID = 5, forename = 'Ruth', surname = 'Letham', date_of_birth = '1978-11-23';

INSERT INTO customer SET person_ID = 5, email_address = 'ruth@letham.com';
...
INSERT INTO customer SET person_ID = 10, email_address = 'jon@spellbad.com';


INSERT INTO personSET ID = 11, forename = 'Jonathan', surname = 'Swift', date_of_birth = '1667-11-30';

INSERT INTO contributor SET person_ID = 11, biography = "Irish author, clergyman and satirist Jonathan Swift received a bachelor's degree from Trinity College and then worked as a statesman's assistant. Eventually, he became dean of St. Patrick's Cathedral in Dublin.";
